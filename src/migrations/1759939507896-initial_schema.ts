...
export class InitialSchema1759939507896 implements MigrationInterface {
    name = 'InitialSchema1759939507896'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movimientos" ("pk_id_movimiento" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_id_inventario" uuid NOT NULL, "mov_stock_reservado" numeric, "mov_stock_devuelto" numeric, "mov_stock_devuelto_sobrante" numeric, "mov_stock_reservado_sobrante" numeric, CONSTRAINT "PK_91a2a1f0b96cd6d718209726117" PRIMARY KEY ("pk_id_movimiento"))`);
        ...
        await queryRunner.query(`CREATE TABLE "inventario_x_actividades" ("pk_id_inventario_x_actividad" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_id_inventario" uuid, "fk_id_actividad" uuid, "ixa_cantidad_usada" numeric, "ixa_activo" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_b5606ec356c22d5fac558d9b8c5" PRIMARY KEY ("pk_id_inventario_x_actividad"))`);
