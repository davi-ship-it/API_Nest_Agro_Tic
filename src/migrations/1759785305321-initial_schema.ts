...
export class InitialSchema1759785305321 implements MigrationInterface {
    name = 'InitialSchema1759785305321'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movimientos" ("pk_id_movimiento" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_id_inventario" uuid NOT NULL, "mov_stock_reservado" numeric, "mov_stock_devuelto" numeric, "mov_stock_devuelto_sobrante" numeric, CONSTRAINT "PK_91a2a1f0b96cd6d718209726117" PRIMARY KEY ("pk_id_movimiento"))`);
