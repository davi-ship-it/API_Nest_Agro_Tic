...
export class InitialSchema1758208876923 implements MigrationInterface {
    name = 'InitialSchema1758208876923'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "inventario" ("pk_id_inventario" uuid NOT NULL DEFAULT uuid_generate_v4(), "inv_nombre" character varying(100) NOT NULL, "inv_descripcion" text, "inv_stock" integer NOT NULL, "inv_precio" numeric NOT NULL, "inv_capacidad_unidad" numeric(10,2), "ivn_fecha_vencimiento" date, "inv_img_url" character varying(255), "fk_id_categoria" uuid, "fk_id_bodega" uuid, CONSTRAINT "PK_236e234c49a4424418cb00e6a14" PRIMARY KEY ("pk_id_inventario"))`);
