...
export class InitialSchema1759361748414 implements MigrationInterface {
    name = 'InitialSchema1759361748414'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cultivos_x_fichas" ("pk_id_cultivo_ficha" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_id_cultivo" uuid NOT NULL, "fk_id_ficha" uuid NOT NULL, CONSTRAINT "PK_acf70dfde508c679cd04fb3561c" PRIMARY KEY ("pk_id_cultivo_ficha"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cultivos_x_fichas" ADD CONSTRAINT "FK_bc8bd2f660cd7a8c1da9e027404" FOREIGN KEY ("fk_id_cultivo") REFERENCES "cultivos"("pk_id_cultivo") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cultivos_x_fichas" ADD CONSTRAINT "FK_654e17cb2d7d4bfb8c00e0d9007" FOREIGN KEY ("fk_id_ficha") REFERENCES "fichas"("pk_id_ficha") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cultivos_x_fichas" DROP CONSTRAINT "FK_654e17cb2d7d4bfb8c00e0d9007"`);
        await queryRunner.query(`ALTER TABLE "cultivos_x_fichas" DROP CONSTRAINT "FK_bc8bd2f660cd7a8c1da9e027404"`);
        ...
        await queryRunner.query(`DROP TABLE "cultivos_x_fichas"`);
