...
export class InitialSchema1759019019556 implements MigrationInterface {
    name = 'InitialSchema1759019019556'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "actividades" ("pk_id_actividad" uuid NOT NULL DEFAULT uuid_generate_v4(), "act_nombre" character varying(255) NOT NULL, "act_descripcion" text NOT NULL, "act_fecha_inicio" date NOT NULL, "act_fecha_fin" date, "act_estado" character varying(10), "act_img_url" character varying(255) NOT NULL, "fk_id_cultivo_variedad_x_zona" uuid NOT NULL, "fk_id_ficha" uuid, CONSTRAINT "PK_0da23a7b5690826fcc0853856ad" PRIMARY KEY ("pk_id_actividad"))`);
        ...
        await queryRunner.query(`CREATE TABLE "fichas" ("pk_id_ficha" uuid NOT NULL DEFAULT uuid_generate_v4(), "ficha_numero" integer NOT NULL, "lote" character varying(50) NOT NULL, "fecha_siembra" date NOT NULL, "fecha_cosecha" date, "cultivoId" uuid, CONSTRAINT "UQ_d4cf2c92f89757be2ba36a82edc" UNIQUE ("ficha_numero"), CONSTRAINT "PK_ffb584f563667ba25e5d371bced" PRIMARY KEY ("pk_id_ficha"))`);
        await queryRunner.query(`CREATE TABLE "recursos" ("pk_id_recurso" uuid NOT NULL DEFAULT uuid_generate_v4(), "recurso_nombre" character varying(100) NOT NULL, "fk_id_modulo" uuid NOT NULL, "fk_id_ficha" uuid, CONSTRAINT "UQ_b6b0becd16a7805a3abd2e8040f" UNIQUE ("recurso_nombre"), CONSTRAINT "PK_d7248e07fcefff849f1ed05b519" PRIMARY KEY ("pk_id_recurso"))`);
        ...
        await queryRunner.query(`ALTER TABLE "actividades" ADD CONSTRAINT "FK_f870c7619617861185f2a2bc4ff" FOREIGN KEY ("fk_id_ficha") REFERENCES "fichas"("pk_id_ficha") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "fichas" ADD CONSTRAINT "FK_9b621b129a8961113e4a44b36f3" FOREIGN KEY ("cultivoId") REFERENCES "cultivos"("pk_id_cultivo") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "recursos" ADD CONSTRAINT "FK_949f142fe41bf419fb100c534ff" FOREIGN KEY ("fk_id_ficha") REFERENCES "fichas"("pk_id_ficha") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "recursos" DROP CONSTRAINT "FK_949f142fe41bf419fb100c534ff"`);
        await queryRunner.query(`ALTER TABLE "recursos" DROP CONSTRAINT "FK_f24d13798abb62d00be138dfc83"`);
        await queryRunner.query(`ALTER TABLE "fichas" DROP CONSTRAINT "FK_9b621b129a8961113e4a44b36f3"`);
        ...
        await queryRunner.query(`ALTER TABLE "actividades" DROP CONSTRAINT "FK_f870c7619617861185f2a2bc4ff"`);
