...
export class InitialSchema1757452587236 implements MigrationInterface {
    name = 'InitialSchema1757452587236'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "usuarios" ("pk_id_usuario" uuid NOT NULL DEFAULT uuid_generate_v4(), "usu_dni" bigint NOT NULL, "usu_nombres" character varying(50) NOT NULL, "usu_apellidos" character varying(50) NOT NULL, "usu_password_h" character varying(255) NOT NULL, "usu_telefono" bigint, "usu_correo" character varying(255) NOT NULL, "fk_id_rol" uuid, CONSTRAINT "PK_51cd6eda4d00711d8046b3371b5" PRIMARY KEY ("pk_id_usuario"))`);
