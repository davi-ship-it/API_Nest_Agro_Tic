...
export class InitialSchema1759429464011 implements MigrationInterface {
    name = 'InitialSchema1759429464011'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "actividades" ("pk_id_actividad" uuid NOT NULL DEFAULT uuid_generate_v4(), "act_descripcion" text NOT NULL, "act_categoria" character varying(100), "act_dni_usuario" character varying(20) NOT NULL, "act_nombre_inventario" character varying(100), "act_fecha_inicio" date NOT NULL, "act_nombre_zona" character varying(100), "fk_id_cultivo_variedad_x_zona" uuid NOT NULL, CONSTRAINT "PK_0da23a7b5690826fcc0853856ad" PRIMARY KEY ("pk_id_actividad"))`);
