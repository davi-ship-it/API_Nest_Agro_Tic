...
export class InitialSchema1757685093593 implements MigrationInterface {
    name = 'InitialSchema1757685093593'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cultivos" ("pk_id_cultivo" uuid NOT NULL DEFAULT uuid_generate_v4(), "cul_descripcion" text, "cul_estado" smallint NOT NULL DEFAULT '1', "cul_siembra" date, CONSTRAINT "PK_bca07ab50918efd3cbfa5d751f9" PRIMARY KEY ("pk_id_cultivo"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tipo_unidad" ("pk_id_tipo_unidad" uuid NOT NULL DEFAULT uuid_generate_v4(), "tip_nombre" character varying(10) NOT NULL, CONSTRAINT "PK_b77280e50b68f8b4ffa9b7ed5a1" PRIMARY KEY ("pk_id_tipo_unidad"))`);
        ...
        await queryRunner.query(`CREATE TABLE "inventario" ("pk_id_inventario" uuid NOT NULL DEFAULT uuid_generate_v4(), "inv_nombre" character varying(100) NOT NULL, "inv_descripcion" text, "inv_stock" integer NOT NULL, "inv_precio" numeric NOT NULL, "inv_capacidad_unidad" numeric(10,2), "ivn_fecha_vencimiento" date, "inv_img_url" character varying(255) NOT NULL, "fk_id_categoria" uuid, "fk_id_bodega" uuid, CONSTRAINT "PK_236e234c49a4424418cb00e6a14" PRIMARY KEY ("pk_id_inventario"))`);
