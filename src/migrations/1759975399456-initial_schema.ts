...
export class InitialSchema1759975399456 implements MigrationInterface {
    name = 'InitialSchema1759975399456'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categoria" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" character varying(100) NOT NULL, "fk_tipo_unidad_id" uuid, CONSTRAINT "UQ_6771d90221138c5bf48044fd73d" UNIQUE ("nombre"), CONSTRAINT "PK_f027836b77b84fb4c3a374dc70d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cultivos" ("pk_id_cultivo" uuid NOT NULL DEFAULT uuid_generate_v4(), "cul_estado" smallint NOT NULL DEFAULT '1', "cul_siembra" date, "fk_id_ficha" uuid, CONSTRAINT "PK_bca07ab50918efd3cbfa5d751f9" PRIMARY KEY ("pk_id_cultivo"))`);
        ...
        await queryRunner.query(`ALTER TABLE "categoria" ADD CONSTRAINT "FK_550106ad69deb355231e1328267" FOREIGN KEY ("fk_tipo_unidad_id") REFERENCES "tipo_unidad"("pk_id_tipo_unidad") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cultivos" ADD CONSTRAINT "FK_7387f3bec06a90bc883a512fae1" FOREIGN KEY ("fk_id_ficha") REFERENCES "fichas"("pk_id_ficha") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cultivos" DROP CONSTRAINT "FK_7387f3bec06a90bc883a512fae1"`);
        ...
        await queryRunner.query(`ALTER TABLE "categoria" DROP CONSTRAINT "FK_550106ad69deb355231e1328267"`);
